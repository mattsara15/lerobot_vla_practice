...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        from lerobot.policies.trivial_policy.modeling_trivial_policy import TrivialPolicy

        return TrivialPolicy
    elif name == "sac":
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "trivial":
        return TrivialConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, TrivialConfig):
        from lerobot.policies.trivial_policy.processor_trivial_policy import make_trivial_pre_post_processors

        processors = make_trivial_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
